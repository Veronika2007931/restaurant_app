import {Drawer,Header, DeleteButton, Content,Footer,CloseButton,CheckoutButton,CartItem } from "./basket.styled.jsx"
...
export const Basket = ({cartItems, onClose, removeItem}) => {
  ...
  return (
    <Drawer>
      <Header>
        <h2>Кошик</h2>
        <CloseButton onClick={onClose}><svg width="23px" height="23px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="Menu / Close_LG">
